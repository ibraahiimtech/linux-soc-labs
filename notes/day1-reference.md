...
- ~17-18 SUID files is normal on Ubuntu Desktop
...
- SUID is not the same as sudo. SUID is automatic file-level power. Sudo is asked-for user-level power.
- last -w prevents fake "tempadmi" ghost accounts caused by username truncation.

## The 5-command audit sequence
